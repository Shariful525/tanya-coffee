...
const AboutUs = () => {
  return <div className="max-w-[470px] mx-auto ">
    <InnerShadow
      text="About Us"
      className="mx-auto"
    ...
    <div className="mt-5 space-y-5">
      <div className="">
        <Image src={assets.aboutUsImage} alt="" width={390} height={320} className="w-full h-auto rounded-[20px]" />
      </div>
      ...
      <div className="relative max-w-md mx-auto bg-white rounded-[20px] p-8 text-center">
        ...
        <p className="text-gray-700 text-lg leading-relaxed  p-5">
          ...
          <span className="font-semibold text-primary uppercase"> TRYING</span> to make our
          world a better, nicer, kinder, compassionate, altruistic, charitable,
          harmonious, peaceful, happy & joyful world that is filled with so much
          of faith, hope, &
          <span className="font-semibold text-primary uppercase"> ESPECIALLY LOVE </span>
