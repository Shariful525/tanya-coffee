...
const MarketingAndAdvertiseCard = ({
  ...
  if (variant === "v1") {
    return (
      <div className="bg-white rounded-2xl p-3 [@media(min-width:400px)]:p-5 flex flex-col items-center text-center shadow-sm hover:shadow-lg transition-shadow duration-300 h-full">
        <div
